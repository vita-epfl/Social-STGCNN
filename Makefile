@ train_gpu:
	...
	# CUDA_VISIBLE_DEVICES=1 python3 trajnet_train.py --lr 0.01 --n_stgcnn 1 --n_txpcnn 5  --dataset colfree_trajdata --tag social-stgcnn-trajnet-data --use_lrschd --num_epochs 250 --obs_seq_len 9
